...
run_step "Local HTTP x402 demo evidence" bash -lc "cd '$ROOT_DIR' && ./scripts/capture-demo-evidence.sh --output-dir '$ROOT_DIR/tmp/final-verify-demo-evidence' --port 3102"
